...
//para verlos por consola 
// console.log( numeroQuini [0]);
// console.log( numeroQuini [1]);
// console.log( numeroQuini [2]);
// console.log( numeroQuini [3]);

// for(logica: si se cumple se repite) {lo que se va a repetir, la instruccion}
